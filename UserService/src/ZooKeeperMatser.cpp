...
bool ZKMatser::start()
{
    ...
    cout << "zk conn_str : " << conn_str << endl;
...
bool ZKMatser::create_master(string master_name)
{
    ...
    {
        int flagg = zoo_create(zkhandle_, path.c_str(), "", 0, &ZOO_OPEN_ACL_UNSAFE, 0, path_buffer, buff_len);
...
void ZKMatser::get_follow()
{
    ...
    cout << "current follower count:" << followers.count << endl;
...
//        cout << followers.data[i] << endl;
        ...
        cout << "znode_path : " << znode_path << endl;
